...
void texturemanager::loadicontextures()
{
    ...
    {"debug", "iron_pickaxe", "iron_axe", "iron_sword", "diamond_pickaxe", "apple", "bread", "potato", "apple_golden", "green_wand", "red_wand", "totem", "fireball", "diamond", "wings",
     "star", "helmet_iron", "ring_green", "ring_red", "skull_skeleton", "boots_blue", "boots_iron", "boots_leather", "chestplate_iron", "fireballhot", "fireballhot2", "clock",
      "crosshair1", "crosshair2", "crosshair3", "crosshair4", "crosshair5", "coal", "iron_ingot", "gold_ingot"},
...
void texturemanager::loadtiletextures()
{
    ...
    glGenerateMipmap(GL_TEXTURE_2D_ARRAY);
    glTexParameteri(GL_TEXTURE_2D_ARRAY, GL_TEXTURE_WRAP_S, GL_REPEAT);//must be repeat or water is weird
    glTexParameteri(GL_TEXTURE_2D_ARRAY, GL_TEXTURE_WRAP_T, GL_REPEAT);
    glTexParameteri(GL_TEXTURE_2D_ARRAY, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D_ARRAY, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
