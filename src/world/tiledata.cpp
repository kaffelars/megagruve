...
void tiledata::initialize()
{
    ...
    tileinfolist.emplace_back(tileinfo{.name="t_water", .fullname="Water block", .ttype = T_WATER, .defaultshape = SHAPE_BLOCK, .lightattenuation = 32,             .hardness = 0,  .glow = 0, .needssupport = false, .overbuildable = true, .passable = true, .biometint = false, .breaktexture = "water", .sidetextures = {"water_side","water_side","water","water","water_side","water_side"}});
    tileinfolist.emplace_back(tileinfo{.name="t_dirt", .fullname="Dirt block", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,              .hardness = 20, .glow = 0, .needssupport = false, .overbuildable = false, .passable = false, .biometint = false, .breaktexture = "dirt", .sidetextures = {"dirt"}});
    ...
    tileinfolist.emplace_back(tileinfo{.name="t_mossydirt", .fullname="Mossy dirt block", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,   .hardness = 20, .glow = 0, .needssupport = false, .overbuildable = false, .passable = false, .biometint = true, .breaktexture = "dirt", .sidetextures = {"dirt"}, .overlaytextures = {"leaves", "leaves", "leaves", "leaves", "leaves", "leaves"}});
    tileinfolist.emplace_back(tileinfo{.name="t_snow", .fullname="Snow block", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,              .hardness = 20, .glow = 0, .needssupport = false, .overbuildable = false, .passable = false, .biometint = false, .breaktexture = "snow", .sidetextures = {"snow"}});
    tileinfolist.emplace_back(tileinfo{.name="t_gravel", .fullname="Gravel block", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,          .hardness = 20, .glow = 0, .needssupport = false, .overbuildable = false, .passable = false, .biometint = false, .breaktexture = "gravel", .sidetextures = {"gravel"}});
    tileinfolist.emplace_back(tileinfo{.name="t_littlegrass", .fullname="Grass tuft block", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255, .hardness = 5,  .glow = 0, .needssupport = false, .overbuildable = false, .passable = false, .biometint = false, .breaktexture = "dirt", .sidetextures = {"dirt", "dirt", "littlegrass", "dirt", "dirt", "dirt"}});
    ...
    tileinfolist.emplace_back(tileinfo{.name="t_hayblock", .fullname="Block of hay", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,        .hardness = 5, .glow = 0, .needssupport = false, .overbuildable = false, .passable = false, .biometint = false, .breaktexture = "hay_block_top", .sidetextures = {"hay_block_side", "hay_block_side", "hay_block_top", "hay_block_top", "hay_block_side", "hay_block_side"}});
    ...
    tileinfolist.emplace_back(tileinfo{.name="t_birch_log", .fullname="Birch tree log", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,     .hardness = 40, .glow = 0, .needssupport = false, .overbuildable = false, .passable = false, .biometint = false, .breaktexture = "log", .sidetextures = {"log_birch", "log_birch", "log_birch_top", "log_birch_top", "log_birch", "log_birch"}});
    tileinfolist.emplace_back(tileinfo{.name="t_planks", .fullname="Planks", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,                .hardness = 30, .glow = 0, .needssupport = false, .overbuildable = false, .passable = false, .biometint = false, .breaktexture = "planks", .sidetextures = {"planks"}});;
    tileinfolist.emplace_back(tileinfo{.name="t_bookcase", .fullname="Bookcase", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,            .hardness = 30, .glow = 0, .needssupport = false, .overbuildable = false, .passable = false, .biometint = false, .breaktexture = "planks", .sidetextures = {"bookcase", "bookcase", "planks", "planks", "bookcase", "bookcase"}});;
    tileinfolist.emplace_back(tileinfo{.name="t_flag", .fullname="Decorative flag block", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,   .hardness = 200, .glow = 0, .needssupport = false,.overbuildable = false,  .passable = false, .biometint = false, .breaktexture = "flag", .sidetextures = {"flag", "flag", "blue", "blue", "flag", "flag"}});
    ...
    tileinfolist.emplace_back(tileinfo{.name="t_cactus", .fullname="Cactus piece", .ttype = T_SOLID_VERT, .defaultshape = SHAPE_CACTUS, .lightattenuation = 255,    .hardness = 15, .glow = 0, .needssupport = true,  .overbuildable = false, .passable = false, .biometint = false, .breaktexture = "green", .sidetextures = {"cactus_side", "cactus_side", "cactus_top", "cactus_top", "cactus_side", "cactus_side"}});
    ...
    tileinfolist.emplace_back(tileinfo{.name="t_glowstone", .fullname="Glowstone", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,          .hardness = 15, .glow = 255, .needssupport = false,.overbuildable = false,  .passable = false, .biometint = false, .breaktexture = "green", .sidetextures = {"glowstone"}});
    tileinfolist.emplace_back(tileinfo{.name="t_bedrock", .fullname="Bedrock block", .ttype = T_SOLID, .defaultshape = SHAPE_BLOCK, .lightattenuation = 255,        .hardness = 255, .glow = 0, .needssupport = false,.overbuildable = false,  .passable = false, .biometint = false, .breaktexture = "bedrock", .sidetextures = {"bedrock"}});
