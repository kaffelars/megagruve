...
void itemmanager::initialize()
{
    ...
    additem("i_magicalclock", "clock", item{.name="Magical clock", .description="Move forward in time", .speed=400, .duration=0, .maxstack=1, .itemtype=itemtype::usable, .subtype=itemsubtype::other, .useeffects=std::vector<std::shared_ptr<effect>>{std::make_shared<movetime>(1.0f)}});
